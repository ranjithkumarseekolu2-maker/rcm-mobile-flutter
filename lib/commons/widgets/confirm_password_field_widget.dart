...
class ConfirmPasswordTextBoxWidget extends StatefulWidget {
  final String hintText;
  final TextEditingController controller;
  var formFieldKey;
  // final Function onTap;

  ConfirmPasswordTextBoxWidget(
...
class _PasswordWidgetState extends State<ConfirmPasswordTextBoxWidget> {
